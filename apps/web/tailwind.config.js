...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Zip theme tokens mapped to CSS variables (HSL)
        ...
        // Keep existing brand palette if referenced elsewhere
        steel: { DEFAULT: "#1f2937", light: "#374151", dark: "#111827" },
        brand: { green: "#00B386", yellow: "#F2C94C", red: "#EF4444" },
      },
      backgroundImage: {
  ...
  fontFamily: { sans: ['var(--font-inter)', 'Inter', 'system-ui', 'sans-serif'] },
      ...
      keyframes: {
        ...
        'fade-in-fast': { from: { opacity: '0', transform: 'translateY(10px)' }, to: { opacity: '1', transform: 'translateY(0)' } },
